							...
							<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td width="250">
											<a href="<?php echo site_url('admin/genap1819s/edit/'.$jadwalaja->id_jadwal) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											<a onclick="deleteConfirm('<?php echo site_url('admin/genap1819s/delete/'.$jadwalaja->id_jadwal) ?>')"
