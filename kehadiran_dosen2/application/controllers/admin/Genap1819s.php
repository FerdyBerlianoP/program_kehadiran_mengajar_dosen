...
class Genap1819s extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view("admin/genap1819/list", $data);
    }
    ...
    public function add()
    {
        ...
        $this->load->view("admin/genap1819/new_form");
    }

    public function edit($id = null)
    {
        if (!isset($id)) redirect('admin/genap1819s');
        ...
        $this->load->view("admin/genap1819/edit_form", $data);
    }
    ...
    public function delete($id=null)
    {
        ...
        if ($this->Genap1819_model->delete($id)) {
            redirect(site_url('admin/genap1819s'));
        }
    }
}
